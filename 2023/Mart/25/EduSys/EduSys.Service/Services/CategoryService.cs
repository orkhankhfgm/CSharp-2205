...
namespace EduSys.Service.Services
{
    public class CategoryService : Service<Category>, ICategoryService
    {
        ...
        public CategoryService(IGenericRepository<Category> repository, IUnitOfWork unitOfWork, IMapper mapper, ICategoryRepository productRepository) : base(repository, unitOfWork)
        {
            _mapper = mapper;
