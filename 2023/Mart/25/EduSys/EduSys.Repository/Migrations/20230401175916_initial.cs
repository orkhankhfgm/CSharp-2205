    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, new DateTime(2023, 4, 1, 21, 59, 16, 19, DateTimeKind.Local).AddTicks(605), "Computer", 800m, 35m, null });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "CreatedDate", "Name", "Price", "Stock", "UpdatedDate" },
                values: new object[] { 2, 2, new DateTime(2023, 4, 1, 21, 59, 16, 19, DateTimeKind.Local).AddTicks(636), "T-Shirt", 50m, 400m, null });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "CreatedDate", "Name", "Price", "Stock", "UpdatedDate" },
                values: new object[] { 3, 3, new DateTime(2023, 4, 1, 21, 59, 16, 19, DateTimeKind.Local).AddTicks(637), "Cat Food", 25m, 1000m, null });

            migrationBuilder.InsertData(
                table: "ProductFeatures",
                columns: new[] { "Id", "Color", "CreatedDate", "Height", "ProductId", "UpdatedDate", "With" },
